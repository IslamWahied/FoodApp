...
import 'package:elomda/shared/components/constants.dart';
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(cubit.activationDone?sucessAcctiveImage:otpGifImage),
                        ),
                      ),
                        Padding(
                        padding: const EdgeInsets.symmetric(vertical: 8.0),
                        child:cubit.activationDone?Padding(
                          padding:
                        ...
                        children: [
                          Padding(
                            ...
                            child: RichText(
                              text:   TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                        text: LoginCubit.get(context).textMobileControl.text??'',
                              ...
                              CountdownTimer(
                                ...
                                widgetBuilder: (_, time) {
                                  return cubit.timerEnd
                                      ? GestureDetector(
                                    onTap: (){
                                      cubit.endTime = DateTime.now().millisecondsSinceEpoch + 1000 * 30;
                                      cubit.timerEnd = false;
                                      cubit.resendActivationCode(context);
                                      cubit.emit(RegisterSuccessState());
                                    },
                                    child: const Text(
                                      'ارسال',
                          ...
                          SizedBox(
                            ...
                            child: RoundedLoadingButton(
                                ...
                                color:cubit.verifiedIsValid?Colors.green: Colors.grey[500],
