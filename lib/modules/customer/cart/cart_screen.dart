  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit, HomeScreenState>(
        ...
        builder: (context, state) {
          ...
          var newOrderList = cubit.listAllOrders.where((element) =>element.orderState.toLowerCase() != 'New'.toLowerCase()  && element.userMobile == Global.mobile).toList();
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          primary: cubit.getTotalPrice() == '0' || cubit.getTotalPrice() == null || cubit.listOrder.isEmpty ? Colors.grey[200] : Constants.primary,
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: SlidableAction(
                                            ...
                                            onPressed: (context) {
                                              ...
                                              cubit.listAllOrders.firstWhere((element) =>element.orderId == orderModel.orderId  && element.projectId == Global.projectId).orderState = 'Prepared';
                                        ...
                                        SizedBox(
                                          ...
                                          child: SlidableAction(
                                            ...
                                            flex: 1,
                                            onPressed: (context) {
                                              cubit.listAllOrders.firstWhere((element) =>  element.orderId == orderModel.orderId  && element.projectId == Global.projectId).orderState = 'New';
                                              var x = cubit.listAllOrders.firstWhere((element) =>element.orderId == orderModel.orderId  && element.projectId == Global.projectId);
                                              cubit.updateOrderState(orderModel: x);
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    HomeCubit.get(context).sendOrder(context);
                  },
                  borderRadius: BorderRadius.circular(30),
                  child: const Padding(
