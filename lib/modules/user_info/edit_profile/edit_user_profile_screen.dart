...
class EditUserProfileScreen extends StatelessWidget {
  ...
  EditUserProfileScreen({Key key ,this.userModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<RegisterCubit, RegisterState>(
      ...
      builder: (context, state) {
        ...
        cubit.txtRegisterProjectNameControl.text = userModel.userName;
        cubit.txtRegisterUserAddressControl.text = userModel.address;
